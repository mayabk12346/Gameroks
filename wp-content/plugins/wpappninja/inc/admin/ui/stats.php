...
function _wpappninja_display_stats_page() {
	...
	<div class="wrap">
		...
		<br/><br/>
		<br/><br/>
		<form action="'.admin_url('admin.php?page=' . WPAPPNINJA_STATS_SLUG).'" method="post">'.wp_nonce_field( 'wpappninja-delete-stats' ).'<input type="hidden" name="wpappninja_delete_stats" value="" /><input style="background: none;border: 0;text-decoration: underline;color: red;margin-left: 20px;" type="submit" value="'.__('Reset all stats').'" /></form>
